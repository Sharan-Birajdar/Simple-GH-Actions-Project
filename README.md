...
It is part of a larger ecosystem supporting a mortgage business that specializes in loan origination and financial services.
...
- Triggered on push to specific branches (e.g., staging)  
- Builds Docker image  
...
- User visits website and views mortgage information  
- User submits form and data is sent to backend systems  
- Admin updates content via WordPress dashboard  
- Developer pushes code and application is deployed automatically via CI/CD  

## Key Highlights

- Full WordPress-based system  
- Cloud-native deployment using AWS ECS  
